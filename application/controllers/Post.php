...
class Post extends CI_Controller
{
    ...
    public function comment($post_id, $user_id)
    {
        ...
        $this->show_comment_form($post_id, $user_id, $comment_errors);
    }
    public function show_comment_form($post_id, $user_id, $comment_errors)
    {   
    ...
    public function share($post_id, $audience="timeline", $audience_id)
    {
        $this->post_model->share($post_id, $audience, $audience_id);
        redirect("user/index/{$_SESSION['user_id']}");
    }
