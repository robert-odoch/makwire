            ...
            foreach ($notifications as $notif) {
                ...
                case 'like':
                    ...
                    elseif ($notif['source_type'] == 'photo') {
                        print "<li><a href='" . base_url("user/photo/{$notif['source_id']}") . "'><strong class='object'>{$notif['actor']}</strong>{$notif['others']} liked your photo.</a> " .
                                " <small class='time'><span class='glyphicon glyphicon-time'></span> {$notif['timespan']} ago</small></li>";
                    }
                ...
                case 'comment':
                    ...
                    elseif($notif['subject_id'] != $_SESSION['user_id']) {
                        ...
                        elseif ($notif['source_type'] == 'photo') {
                            if ($notif['subject_id'] == $notif['actor_id']) {
                                print "<li><a href='" . base_url("photo/comments/{$notif['source_id']}") . "'><strong class='object'>{$notif['actor']}</strong>{$notif['others']} commented on {$notif['subject_gender']} photo you shared.</a> " .
                                      " <small class='time'><span class='glyphicon glyphicon-time'></span> {$notif['timespan']} ago</small></li>";
                            }
                            else {
                                print "<li><a href='" . base_url("photo/comments/{$notif['source_id']}") . "'><strong class='object'>{$notif['actor']}</strong>{$notif['others']} commented on a photo you shared.</a> " .
                                      " <small class='time'><span class='glyphicon glyphicon-time'></span> {$notif['timespan']} ago</small></li>";
                            }
                        }
                    }
                ...
                case 'share':
                    ...
                    elseif ($notif['source_type'] == 'photo') {
                        print "<li><a href='" . base_url("/user/photo/{$notif['source_id']}") . "'><strong class='object'>{$notif['actor']}</strong>{$notif['others']} shared your photo.</a> " .
                        " <small class='time'><span class='glyphicon glyphicon-time'></span> {$notif['timespan']} ago</small></li>";
                    }
                    break;
                case 'birthday':
