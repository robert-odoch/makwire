...
<div class="box">
    ...
    <ul class="chat-friends">
        ...
        <li>
            <figure>
                <img src="<?= base_url("images/kasumba.jpg"); ?>" alt="<?= "{$cu['display_name']}'s photo"; ?>">
            </figure>
            <span>
                <a href="<?= base_url("user/send-message/{$cu['friend_id']}"); ?>"><?= $cu['display_name']; ?></a> <span class="logged-in"></span>
            </span>
        </li>
        <?php endforeach; ?>
    </ul>
